...
class Lianjia(object):
    ...
    def __init__(self):
        # self.url = "https://gz.lianjia.com/ershoufang/"  # 二手房网站，广州
        self.url = "https://su.lianjia.com/ershoufang"  # 二手房网站
        self.url_bash = "https://su.lianjia.com"  # 广州链家主网站
    ...
    def get_area_one_house(self, url_area, page):
        ...
        try:
            ...
            lianjia_data['elevator'] = [i.split(' | ')[5] if len(i.split(' | ')) == 6 else '-' for i in
                                        descriptions]  # 有无电梯
...
lianjia_area_datas.to_csv('e:/lianjia_su_ershoufang.csv',encoding='utf_8_sig')
